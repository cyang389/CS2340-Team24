...
import com.example.jenson.cs2340_team24_project.UI.Controllers.AddDonationActivity;
...
public class AddDonationTest {
    ...
    public void getItemTest() {
        when(mockedDatabaseReference.child("donations")).thenReturn(mockedDatabaseReference);
        doAnswer(new Answer() {
            @Override
